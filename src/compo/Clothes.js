...
const Clothes = () => {
  ...
  const selectedCategory = 'clothes'; // Set your desired category here
  ...
  return (
    <div className="col-md-19 mb-1">
      <h1 className='searchs'>Clothes Men&Women-</h1>
      <div className='row'>
...
const Clothes = () => {
  ...
  return (
    <div className="col-md-7 mb-9">
      <h1 className='search'> Clothes Men&women</h1>
      <div className='row'>
        {products.map(product => (
          <div className='col-md-5 product-card' key={product._id}>
            <Card className='product-card__'>
              <Card.Img className='product-card__image' variant='top' src={product.img} />
              <Card.Body>
                <Card.Title className='product-card__price'>{product.title}</Card.Title>
...
const Clothes = () => {
  ...
  return (
    <div className="col-md-7 mb-9">
      <h1 className='search'>Women Clothes</h1>
      <div className='row'>
        {products.map(product => (
          <div className='col-md-5' key={product._id}>
            <Card style={{ width: '100%' }}>
              <Card.Img variant='top' src={product.img} />
              <Card.Body>
                <Card.Title>{product.title}</Card.Title>
                <Card.Text>desc: {product.desc}</Card.Text>
          ...
          <div className='col-md-5'>
            <Card style={{ width: '100%' }}>
              ...
              <Card.Body>
                ...
                <Card.Text>desc: {selectedProduct.desc}</Card.Text>
