...
const Bags = () => {
  ...
  const selectedCategory = 'hanger'; // Set your desired category here
  ...
  return (
    <div className="col-md-19 mb-1">
      <h1 className='searchs'>Hangers Items</h1>
      <div className='row'>
...
const Bags = () => {
  ...
  useEffect(() => {
    fetch('https://dummyjson.com/products/26')
      .then(response => response.json())
      .then(data => {
  ...
  return (
    <div className="col-md-7 mb-9">
      <h1 className='search'>Product of Hangers</h1>
      {selectedProduct && (
        <div className='row'>
